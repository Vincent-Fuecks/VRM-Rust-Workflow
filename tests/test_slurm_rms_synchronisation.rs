...
// 2. Define the individual switches for the topology
    ...
    return Ok(SlurmRmsDto { id: "RMS-ID".to_string(), scheduler_typ: "SlottedSchedule".to_string(), slot_width: 60, num_of_slots: 60, rest_api_config: rest_api_config, topology: topology});
