...
pub struct GridComponentBase {
    pub id: String,
    pub children: HashMap<String, Recipient<Envelope>>,
    pub parent: Option<Recipient<Envelope>>,
    pub typ: GridComponentTyp,
}

impl GridComponentBase {
    pub fn new(id: String, children: HashMap<String, Recipient<Envelope>>, parent: Option<Recipient<Envelope>>, typ: GridComponentTyp) -> Self {
    ...
    where
        A: Actor<Context = Context<A>> + Handler<GridComponentMessage>,
    {
