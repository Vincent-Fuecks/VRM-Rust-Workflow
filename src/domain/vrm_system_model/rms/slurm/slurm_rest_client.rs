...
impl SlurmRestApiClient {
    pub fn new(slurm_config_dto: SlurmConfigDto) -> Result<Self> {
        ...
        let config = SlurmConfig { base_url: slurm_config_dto.base_url, version: slurm_config_dto.version, user_name: slurm_config_dto.user_name, jwt_token: slurm_config_dto.jwt_token };
